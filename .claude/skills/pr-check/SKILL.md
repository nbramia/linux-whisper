...
Review a pull request against linux-whisper's PR standards.
...
- New functions/classes in `src/` have tests in `tests/`
...
- New pipeline stages (STT backend, polish stage)
- Refactors that must be atomic
- Generated code (icons, config schemas)
